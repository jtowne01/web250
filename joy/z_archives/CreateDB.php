...
if ($mysqli->query("CREATE DATABASE IF NOT EXISTS if0_38362188_cars"))
{
    echo "<p>Database cars created</P>";
}
else
{
    echo "Had trouble with this SQL: CREATE DATABASE IF NOT EXISTS if0_38362188_cars";
}
...
$query = "INSERT INTO `inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`) 
VALUES 
...
$query3 = "INSERT INTO `inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`)
 VALUES
