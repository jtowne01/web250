...
if ($mysqli->query("CREATE DATABASE if0_38362188_cars") === TRUE) {
...
$query = "INSERT INTO `if0_38362188_cars`.`inventory` 
...
$query = "INSERT INTO `if0_38362188_cars`.`inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`) 
VALUES 
