...
// check if Primary_Image column exists
$checkColumn = $mysqli->query("SHOW COLUMNS FROM `inventory` LIKE 'Primary_Image'");
if ($checkColumn->num_rows === 0) {
    ...
    echo "<p>'Primary_Image' column already exists. Skipping ALTER TABLE.</p>";
}
