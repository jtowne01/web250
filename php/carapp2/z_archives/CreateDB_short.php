...
if ($mysqli->query("CREATE DATABASE if0_38362188_jazzytiger") === TRUE) {
...
$query = "INSERT INTO `if0_38362188_jazzytiger`.`inventory` 
...
$query = "INSERT INTO `if0_38362188_jazzytiger`.`inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`) 
VALUES 
