...
if ($mysqli->query("CREATE DATABASE IF NOT EXISTS if0_38362188_jazzytiger"))
{
    echo "<p>Database cars created</P>";
}
else
{
    echo "Had trouble with this SQL: CREATE DATABASE IF NOT EXISTS if0_38362188_jazzytiger";
}
/* 
