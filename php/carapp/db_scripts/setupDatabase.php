...
if ($mysqli->query("CREATE DATABASE IF NOT EXISTS if0_38362188_jazzytiger1"))
{
    echo "<p>Database cars created</P>";
}
else
{
    echo "Had trouble with this SQL: CREATE DATABASE IF NOT EXISTS if0_38362188_jazzytiger1";
}

$mysqli->select_db("if0_38362188_jazzytiger1");
   Echo ("Selected the jazzytiger1 database. ");
...
?>
<html>
<a href="https://jtowne.great-site.net/carapp">Home</a>
</html>